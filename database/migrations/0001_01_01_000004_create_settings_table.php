...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('settings', function (Blueprint $table) {
            $table->id()->from(10000000)->comment('配置ID');
        ...
        Setting::batchSet([
            // 基本设置
            ['name' => '网站URL', 'key' => 'system.url', 'value' => 'https://www.xxx.com', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => 'string',
                'remark' => '网站URL（一般为https://www.xxx.com）。'],
            ['name' => '移动网站URL', 'key' => 'system.m_url', 'value' => 'https://m.xxx.com', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => 'string',
                'remark' => '移动网站URL（一般为https://m.xxx.com）。'],
            ['name' => '网站标题', 'key' => 'system.title', 'value' => 'Laravel 13', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => 'string',
                'remark' => '网站标题（一般不超过80个字符）。'],
            ['name' => '网站关键词', 'key' => 'system.keywords', 'value' => 'Laravel 13', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => 'string',
                'remark' => '网站关键词（一般不超过100个字符）。'],
            ['name' => '网站描述', 'key' => 'system.description', 'value' => 'Laravel 13', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => 'textarea',
                'remark' => '网站描述（一般不超过200个字符）。'],
            ['name' => 'ICP备案号', 'key' => 'system.icp_beian', 'value' => 'ICP备XXXX号', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => 'string',
                'remark' => '信产部备案号。'],
            ['name' => '公安备案号', 'key' => 'system.police_beian', 'value' => '公安备XXXX号', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => 'string',
                'remark' => '公安部备案号。'],
            ['name' => '服务邮箱', 'key' => 'system.support_email', 'value' => 'support@xxx.com', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => 'string',
                'remark' => '服务邮箱（一般为support@xxx.com）。'],
            ['name' => '服务电话', 'key' => 'system.support_phone', 'value' => '13800000000', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => 'string',
                'remark' => '服务电话（一般为13800000000）。'],
            ['name' => '法律邮箱', 'key' => 'system.lawyer_email', 'value' => 'lawyer@xxx.com', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => 'string',
            ...
            ['name' => '用户注册节流', 'key' => 'user.register_throttle', 'value' => '10,3', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => 'string',
                'remark' => '1分钟5次，则输入5,1'],
            ['name' => '用户登录节流', 'key' => 'user.login_throttle', 'value' => '10,3', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => 'string',
                'remark' => '1分钟5次，则输入5,1'],
