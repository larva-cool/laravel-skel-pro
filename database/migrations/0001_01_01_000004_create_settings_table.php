...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Setting::batchSet([
            ...
            ['name' => '网站标题', 'key' => 'system.title', 'value' => 'Laravel 13', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => SettingType::CAST_TYPE_STRING,
                'remark' => '网站标题（一般不超过80个字符）。'],
            ['name' => '网站关键词', 'key' => 'system.keywords', 'value' => 'Laravel 13', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => SettingType::CAST_TYPE_STRING,
                'remark' => '网站关键词（一般不超过100个字符）。'],
            ['name' => '网站描述', 'key' => 'system.description', 'value' => 'Laravel 13', 'cast_type' => SettingType::CAST_TYPE_STRING, 'input_type' => SettingType::CAST_TYPE_STRING,
